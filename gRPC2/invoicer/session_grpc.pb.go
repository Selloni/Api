...
const (
	AuthChecker_Create_FullMethodName = "/AuthChecker/Create"
	AuthChecker_Check_FullMethodName  = "/AuthChecker/Check"
	AuthChecker_Delete_FullMethodName = "/AuthChecker/Delete"
)
